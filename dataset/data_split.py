...
np.savez(f'{dataset_type}/{mode}_512.npz', x=data_512, y=y)
np.savez(f'{dataset_type}/{mode}_1024.npz', x=data_1024, y=y)
np.savez(f'{dataset_type}/{mode}_2048.npz', x=data_2048, y=y)